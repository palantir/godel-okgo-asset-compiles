...
import (
	...
	"github.com/palantir/godel-okgo-asset-compiles/compiles/config/internal/legacy"
	v0 "github.com/palantir/godel-okgo-asset-compiles/compiles/config/internal/v0"
)
